    ...
    <div className='flex flex-col h-screen w-screen  justify-center px-2 bg-neutral-900 '>
        ...
        <div className='flex items-baseline-last justify-center  mb-10'>
            <div className=' break-all  p-10 flex  w-auto ' > 
                ...
                <p className='text-white font-gothic leading-none  text-[60px] sm:text-[90px] md:text-[120px] lg:text-[200px] xl:text-[290px] '>{hours}:</p>
                <p className='text-white font-gothic leading-none  text-[60px] sm:text-[90px] md:text-[120px] lg:text-[200px] xl:text-[290px]'>{minutes}</p>
